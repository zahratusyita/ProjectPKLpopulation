                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name" id="name"
                                                        value="{{ old('name', $user->name) }}" placeholder="Enter ..."
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" name="email" id="email"
                                                        value="{{ old('email', $user->email) }}" placeholder="Enter ..."
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="user_type" id="user_type" class="form-control" required>
                                                ...
                                                <option value="A" {{ $user->user_type == 'A' ? 'selected' : '' }}>Admin
                                                    Provinsi</option>
                                                <option value="B" {{ $user->user_type == 'B' ? 'selected' : '' }}>Admin
                                                    Kabupaten/Kota</option>
                                                <option value="C" {{ $user->user_type == 'C' ? 'selected' : '' }}>Admin
                                                    Kecamatan</option>
                                            </select>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="password">Password Baru (Biarkan kosong jika tidak ingin
                                                        mengubah)</label>
                                                    <input type="password" class="form-control" name="password"
                                                        id="password" placeholder="Enter baru ..."
