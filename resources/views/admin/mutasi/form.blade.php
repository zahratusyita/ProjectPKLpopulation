                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Tambah Data Mutasi {{ ucfirst($jenis) }}</h3>
                            </div>
                            <form action="{{ route('mutasi.store', ['jenis' => $jenis]) }}" method="POST">
                                {{ csrf_field() }}
                                <div class="card-body">
                                    @if ($errors->any())
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="peternak" id="peternak" required>
                                                    ...
                                                    @foreach($peternak as $pt)
                                                        <option value="{{ $pt->id }}" @selected(old('peternak') == $pt->id)>
                                                            {{ $pt->nama }} ({{ $pt->nik }})
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" min="0" class="form-control" name="{{ $field }}_jantan" id="{{ $field }}_jantan" value="{{ old($field.'_jantan', 0) }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="{{ $field }}_betina">{{ $label }} Betina</label>
                                                            <input type="number" min="0" class="form-control" name="{{ $field }}_betina" id="{{ $field }}_betina" value="{{ old($field.'_betina', 0) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" min="0" class="form-control" name="{{ $field }}_{{ $ageKey }}_jantan" id="{{ $field }}_{{ $ageKey }}_jantan" value="{{ old($field.'_'.$ageKey.'_jantan', 0) }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label for="{{ $field }}_{{ $ageKey }}_betina">{{ $label }} {{ $ageLabel }} Betina</label>
                                                                <input type="number" min="0" class="form-control" name="{{ $field }}_{{ $ageKey }}_betina" id="{{ $field }}_{{ $ageKey }}_betina" value="{{ old($field.'_'.$ageKey.'_betina', 0) }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            ...
                                            @foreach($unggas as $field => $label)
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control" name="{{ $field }}" id="{{ $field }}" value="{{ old($field, 0) }}">
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="keterangan" id="keterangan" placeholder="Penjelasan tambahan bila diperlukan">{{ old('keterangan') }}</textarea>
                                    </div>
                                </div>
