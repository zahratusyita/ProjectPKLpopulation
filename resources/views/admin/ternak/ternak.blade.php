                    ...
                    <div class="col-12">
                        <div class="card">
                                    ...
                                    <h3 class="card-title">Data Ternak 
                                        @if(Auth::user()->user_type == 'C')
                                            @if($status_verifikasi['status_pengajuan'] == 0)
                                                ...
                                                <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-import-ternak">
                                        ...
                                        <a href="{{ route('ternak.export').'?kab_kota='.$_REQUEST['kab_kota'].'&kecamatan='.$_REQUEST['kecamatan'].'&desa_kel='.$_REQUEST['desa_kel'].'&search='.$_REQUEST['search'] }}" class="btn btn-sm btn-success ml-2"><i class="fas fa-table"></i> Export</a>
                                        @else
                                        <a href="{{ route('ternak.export').'?kab_kota=&kecamatan=&desa_kel=&search=' }}" class="btn btn-sm btn-success ml-2"><i class="fas fa-table"></i> Export</a>
                                        @endif
                                    </h3>
                                </div>
                            ...
                            <div class="card-footer">
                                Halaman : {{ $ternak->currentPage() }} |
                                Jumlah Data : {{ $ternak->total() }} |
                                Data per Halaman : {{ $ternak->perPage() }}
                                {{ $ternak->links() }}
                            </div>
                        </div>
                    <!-- /.card -->
